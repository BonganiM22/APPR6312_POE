...
namespace APPR6312_ST10104738_POE.Controllers
{
    ...
    public class GoodsDonationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GoodsId,DonatorName,GoodsDonationDate,GoodsCategory,GoodsQuantity,GoodsDescription")] GoodsDonation goodsDonation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GoodsId,DonatorName,GoodsDonationDate,GoodsCategory,GoodsQuantity,GoodsDescription")] GoodsDonation goodsDonation)
        {
